...
enum API_URLs {
    ...
    static let apiKey = "90f78b5e459f4557a6d285161db89387" /* I had issues with my apiKey, so I used the key which is at example project 
                                                                                my key = fe5dd6ca68374ea4aff8c73550a00aaf */
